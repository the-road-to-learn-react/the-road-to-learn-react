...
Jest stores snapshots in a folder so it can validate the diff against a future snapshot. This also lets user share snapshots across teams when having version control such as git in place.
